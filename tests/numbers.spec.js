...
describe('2 - Implemente os casos de teste para a função `numbers`', () => {
  ...
  it('Verifica se a função "numbers" recebe [1, 2, 3, 4, 5] e retorna true', () => {
    expect(numbers([1, 2, 3, 4, 5])).toEqual(true);
  });
  it('Verifica se a função "numbers" recebe [1, 2, "3", 4, 5] e retorna false', () => {
    expect(numbers([1, 2, '3', 4, 5])).toEqual(false);
  });
  it('Verifica se a função "numbers" recebe [1, "a", 3] e retorna false', () => {
    expect(numbers([1, 'a', 3])).toEqual(false);
  });
  it('Verifica se a função "numbers" recebe [" "] e retorna false', () => {
